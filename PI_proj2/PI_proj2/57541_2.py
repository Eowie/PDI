...
from skimage.morphology import rectangle, erosion, dilation, watershed, \
...
fig1=plt.figure()
fig1.suptitle('Exercício 1')
plt.subplot(141); plt.imshow(LSat, 'gray'); plt.title('Original Cinzento'); plt.axis('off')
plt.subplot(142); plt.imshow(LSat_bin, 'gray'); plt.title('Imagem Binária'); plt.axis('off')
plt.subplot(143); plt.imshow(LSat_f, 'gray'); plt.title('Abertura+Fecho'); plt.axis('off')
plt.subplot(144); plt.imshow(LSat_med, 'gray'); plt.title('Linha Média Rio'); plt.axis('off')

fig2=plt.figure()
fig2.suptitle('Exercício 2')
plt.subplot(141); plt.imshow(Ik, 'gray'); plt.title('Original Cinzento'); plt.axis('off')
plt.subplot(142); plt.imshow(estradas_final0, 'gray'); plt.title('Resultado Inicial'); plt.axis('off')
plt.subplot(143); plt.imshow(estradas_final,'gray'); plt.title('Resultado Final'); plt.axis('off')
plt.subplot(144); plt.imshow(estradas_finala, 'gray'); plt.title('Solução Alternativa'); plt.axis('off')

fig3=plt.figure()
fig3.suptitle('Exercício 3')
plt.subplot(131);plt.imshow(Ik0,'gray');plt.title('Original Cinzento'); plt.axis('off')
plt.subplot(132);plt.imshow(telhado1,'gray');plt.title('Telhados das casas'); plt.axis('off')
plt.subplot(133);plt.imshow(telhado2,'gray');plt.title('Telhados das casas - Suavizado'); plt.axis('off')
