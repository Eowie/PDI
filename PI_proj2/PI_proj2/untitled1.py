...
t_ik1=deepcopy(img2_g)
t_ik1[0:340,0:]=0
t_ik1[:,370:]=0
t_ik1[340:380,200:370]=0
t_ik1[380:400,270:370]=0
t_ik1[400:430,270:370]=0
t_ik1[430:450,300:370]=0
...
plt.subplot(231); plt.imshow(t_ik1, 'gray'); plt.title('Original Cinzento'); plt.axis('off')
