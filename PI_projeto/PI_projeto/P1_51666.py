...
plt.subplot(332);plt.imshow(Img,'gray',vmin=0,vmax=255)
plt.title('Imagem Original'); plt.axis('off')
plt.subplot(334);plt.imshow(PB1,'gray',vmin=0,vmax=255)
plt.title('PB1'); plt.axis('off')
plt.subplot(335);plt.imshow(PA2,'gray', vmin=0,vmax=255)
plt.title('PA2'); plt.axis('off')
plt.subplot(336);plt.imshow(Imagem_corrigida_linhas,'gray', vmin=0,vmax=255)
plt.title('Imagem corrigida de ruído horizontal'); plt.axis('off')
plt.subplot(337);plt.imshow(PB3,'gray', vmin=0,vmax=255)
plt.title('PB3'); plt.axis('off')
plt.subplot(338);plt.imshow(PA4,'gray', vmin=0,vmax=255)
plt.title('PA4'); plt.axis('off')
plt.subplot(339);plt.imshow(Imagem_filtrada,'gray', vmin=0,vmax=255)
